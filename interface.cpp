...
void drawMenu() {
    ...
    cout << "\033[1;33m"
         << "|  0. Verificar se o grafo é conexo           |" << endl
         << "|  1. Verificar se o grafo é bipartido        |" << endl
         << "|  2. Verificar se o grafo é euleriano        |" << endl
         << "|  3. Verificar se o grafo possui ciclos      |" << endl
         << "|  4. Contar componentes conexas              |" << endl
         << "|  5. Contar componentes fortemente conexas   |" << endl
         << "|  6. Encontrar vértices de articulação       |" << endl
         << "|  7. Encontrar arestas ponte                 |" << endl
         << "|  8. Exibir ordem de busca em profundidade   |" << endl
         << "|  9. Exibir ordem de busca em largura        |" << endl
         << "|  10. Exibir árvore geradora mínima (Prim)   |" << endl
         << "|  11. Exibir ordem topológica                |" << endl
         << "|  12. Exibir caminho mínimo (Dijkstra)       |" << endl
         << "|  13. Exibir fluxo máximo                    |" << endl
         << "|  14. Exibir fecho transitivo                |" << endl
         << "|  15. Sair                                   |" << endl
         << "\033[0m";

    cout << "\033[1;32mEscolha uma opção: \033[0m";
}
...
int main() {
    ...
    cout << "\033[1;37mDigite o número de vértices: \033[0m";
    cin >> vertices;
    cout << "\033[1;37mDigite o número de arestas: \033[0m";
    cin >> arestas;

    cout << "\033[1;37mO grafo é direcionado (digite 'direcionado') ou não direcionado (digite 'nao-direcionado')? \033[0m";
    cin >> ehdirecionado;
    ...
    for (int i = 0; i < arestas; i++) {
        int a, u, v, peso;
        cout << "\033[1;37mDigite o índice da aresta, o vértice de saída, o vértice de entrada e o peso (separados por espaço): \033[0m";
        cin >> a >> u >> v >> peso;
    ...
    while (true) {
        ...
        switch (opcao) {
            case 0:
                cout << "\033[1;36mResultado: " << grafo.ehConexo() << "\033[0m" << endl;
                break;
            case 1:
                cout << "\033[1;36mResultado: " << grafo.ehBipartido() << "\033[0m" << endl;
                break;
            case 2:
                cout << "\033[1;36mResultado: " << grafo.ehEuleriano() << "\033[0m" << endl;
                break;
            case 3:
                cout << "\033[1;36mResultado: " << grafo.possuiCiclos() << "\033[0m" << endl;
                break;
            case 4:
                cout << "\033[1;36mResultado: " << grafo.contarComponentesConexas() << "\033[0m" << endl;
                break;
            case 5:
                cout << "\033[1;36mResultado: " << grafo.contarComponentesFortementeConexas() << "\033[0m" << endl;
                break;
            case 6:
            ...
            case 12:
                ...
                break;
            case 13:
                cout << "\033[1;36mResultado: " << grafo.fluxoMaximo() << "\033[0m" << endl;
                break;
            case 14:
                grafo.fechoTransitivo();
                break;
            case 15:
                cout << "\033[1;31mSaindo...\033[0m" << endl;
                return 0;
            default:
                cout << "\033[1;31mOpção inválida. Tente novamente.\033[0m" << endl;
                break;
        }

        cout << "\033[1;34mPressione ENTER para continuar...\033[0m";
        cin.ignore();
        cin.get();   
    }
